                    ...
                    <div className="w-full">
                        <div className="flex w-full">
                            <div className="flex flex-col gap-2">
                                ...
                                <a
                                    href="/my-account"
                                    className={`pl-3.5 ml-4 text-gray-500 duration-100 hover:text-red-600 ${activePage === "profile" ? "bg-red-200" : ""}`}
                                >Thông tin cá nhân
                                </a>
                                <a
                                    href="my-account/manage-address"
                                    className={`pl-3.5 ml-4 text-gray-500 duration-100 hover:text-red-600 ${activePage === "address" ? "bg-red-200" : ""}`}
                                >Địa chỉ
                                </a>
                                <a
                                    href="my-account/change-password"
                                    className={`pl-3.5 ml-4 text-gray-500 duration-100 hover:text-red-600 ${activePage === "password" ? "bg-red-200" : ""}`}
                                >Đổi mật khẩu
                                </a>
                            </div>
                        </div>
                            ...
                            {showLogoutModal && (
                                <div className="modal">
                                    <div className="modal-content">
                                        <span className="close" onClick={handleCancelLogout}>&times;</span>
