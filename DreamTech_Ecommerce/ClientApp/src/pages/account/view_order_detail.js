...
function ViewOrderDetail() {
    ...
    useEffect(() => {
        const fetchOrderDetails = async () => {
            try {
                const res = await getDataAPIWithAuth(`Order/GetOrderById/${orderId}`, token);
                                ...
                                <div class="right-main-box tab-content customers-orders-history" id="orders-history">
                                    <div class="box-heading">
                                        <div class="line-title">
                                            <h2>Chi tiết đơn hàng #{orderDetails.id} - <span class="order-status">{getOrderStatusLabel(orderDetails.orderStatus)}</span></h2>
                                    ...
                                    <div class="detail-box-info-account">
                                        <div id="order_info" class="order-info">
                                            <div class="info-box" id="order_customer">
                                                ...
                                                <div class="info-box--body">
                                                    <div class="name-receive"><span>Người nhận:</span> <span>{orderDetails.user && `${orderDetails.user.firstName} ${orderDetails.user.lastName}`}  - 0397764020</span></div>
                                                    <div class="address-receive"><span>Địa chỉ nhận hàng:</span> <span>{orderDetails.shippingAddress}</span></div>
                                            ...
                                            <div class="info-box" id="order_payment">
                                                ...
                                                <div class="info-box--body"><div class="unpaid"><span>Đã thanh toán</span></div></div>
                                            </div>
                                        </div>
                                        <div id="order_details" class="wrap_order">
                                                ...
                                                <div class="info-box--body">
                                                    <div class="table-order">
                                                        <div class="order-group single">
                                                            {orderDetails.orderDetails && orderDetails.orderDetails.map((orderItem) => (
                                                                <div key={orderItem.id}>
                                                                    <div id="1709660626" data-vrid="1106614622" data-prid="1047215379" class="line-item">
                                                                        <div class="left">
                                                                            <div class="image">
                                                                                <img src={orderItem.product.productImages[0].imageUrl} alt="Product Image" />
                                                                            </div>
                                                                            <div class="info">
                                                                                <div class="name">{orderItem.product.name}</div>
                                                                                <div class="meta">
                                                                                    <span class="quantity">Số lượng: {orderItem.qty}</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="right">
                                                                            <div class="total money text-right">
                                                                                <div class="total-price">{formatPrice(orderItem.product.price)}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="total-order offset-lg-6 py-2" id="order_details_total">
                                                <div class="ac_line subtotal-price">
                                                    <div class="ac_line--l"><span>Giá tạm tính:</span></div>
                                                    <div class="ac_line--r"><span>{formatPrice(orderDetails.totalAmount)}</span></div>
                                                </div>
                                                <div class="ac_line shipping-fee">
                                                    <div class="ac_line--l"><span>Phí vận chuyển:</span></div>
                                                    <div class="ac_line--r"><span>Miễn phí</span></div>
                                                </div>

                                                <div class="ac_line discounts-fee d-none">
                                                    <div class="ac_line--l"><span>Giảm giá trên đơn hàng:</span></div>
                                                    <div class="ac_line--r"><span></span></div>
                                                </div>

                                                <div class="ac_line maintotal-price">
                                                    <div class="ac_line--l"><span>Tổng tiền:</span></div>
                                                    <div class="ac_line--r"><span>{formatPrice(orderDetails.totalAmount)}</span></div>
                                                </div>
                                                <div class="ac_line amount-paid">
                                                    ...
                                                    <div class="ac_line--r"><span><b>{formatPrice(orderDetails.totalAmount)}</b></span></div>
                                                </div>
                                            </div>
                                            <div class="action-order">
                                                <NavLink to="/account/orders-history" class="action-order">
                                                    <div class="btn-back">  Quay lại danh sách đơn hàng</div>
                                                </NavLink>
                                            </div>
                                        </div>
                                    </div>
