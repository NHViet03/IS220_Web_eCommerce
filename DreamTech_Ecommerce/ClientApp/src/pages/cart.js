      ...
      <div className="flex justify-center">
          <div className="cart-wrapper">
              <div className="breadcrumb-wrapper my-3">
                  {step > 1 ? 
                      (
                      <a className="ms-3 font-medium text-primary py-2 cursor-pointer" onClick={() => step > 1 && setStep(step - 1)}>
                          <i className="fas fa-chevron-left pe-2" style={{fontSize: "0.75rem"}}></i>
                          <span className="text-sm">Trở về</span>
                      </a>
                      ) : (
                      <Link to={"/"} className="ms-3 font-medium text-primary py-2">
                          <i className="fas fa-chevron-left pe-2" style={{fontSize: "0.75rem"}}></i>
              ...
              <div className="cart-main rounded-sm mb-3 p-3">
                  ...
                  <div className="summary py-3">
                      ...
                      <div className="total-amount flex justify-between items-center font-semibold pt-1">
                          <div className="text-normal">Tổng tiền: </div>
                          <div className="text text-xl">53.980.000₫</div>
                      </div>
                  </div>
                  {/* Submit Button */}
                  <div className="action-section">
                      <button className="block text-center action-button uppercase w-full" onClick={() => setStep(step + 1) }>
                          {step < 3 ? "Đặt hàng ngay" : "Thanh toán"}
                      </button>
                  </div>
              </div>
        </div>
